...
MODULES = [
    ...
    "hyperscaled.models.miner",
    "hyperscaled.models.trading",
    "hyperscaled.models.account",
    "hyperscaled.models.payout",
    "hyperscaled.models.registration",
    "hyperscaled.models.rules",
